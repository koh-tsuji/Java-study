...
次回：タスク一覧表示
 ...
 2026/06/28
・ ArrayListに保存したタスクの一覧表示を実装
・ for文を学習
・ size()で要素数を取得
・ get()で要素を取り出す方法を学習
・ ArrayListのインデックスは0から始まることを理解
...
★ 振り返り
for文やArrayListの操作はまだ完全に理解できているわけではないが、
コードの意味を考えながら修正できるようになってきた。
以前よりもコピペだけではなく、
処理の流れを少しずつ理解しながら開発できるようになっている。
 次回：タスク削除機能
 　　　remove()の学習
    　入力チェックの強化
